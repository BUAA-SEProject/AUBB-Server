...
基于当前代码基线，继续补齐“已有但尚未收口”的真实能力。当前优先收口 `grading` 的 assignment 权重与加权总评第一阶段，让教师 / 学生成绩册、CSV 导出和统计报告在现有最新正式提交聚合之上稳定返回加权总分、权重合计和加权得分率，使成绩能力从“可导出 / 可统计”继续推进到“可表达课程内基础总评规则”。

## 当前阶段

Phases 15 / 16 / 17 / 18 / 19 in progress，Phases 20 / 21 / 22 / 23 / 24 / 29 / 30 / 31 / 32 completed

...
基于当前代码基线，继续补齐“已有但尚未收口”的真实能力。当前优先收口 `grading` 的统计报告五档成绩分布第一阶段，让教师 / 管理员 / 班级责任 TA 在既有 report 接口上直接看到总体、作业和班级的成绩分布，而不引入新的权限边界和额外统计表。

## 当前阶段

Phases 15 / 16 / 17 / 18 / 19 in progress，Phases 20 / 21 / 22 / 23 / 24 / 29 / 30 / 31 / 32 / 33 / 34 completed

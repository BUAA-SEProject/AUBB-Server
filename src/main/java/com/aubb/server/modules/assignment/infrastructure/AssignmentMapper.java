...
public interface AssignmentMapper extends BaseMapper<AssignmentEntity> {
    ...
    @Select({
        ...
        "        JOIN role_bindings rb ON rb.user_id = cm.user_id",
        "         AND rb.source_type = 'LEGACY_COURSE_MEMBER'",
        "         AND rb.source_ref_id = cm.id",
        ...
        "          AND cm.offering_id = a.offering_id",
        "          AND cm.member_role = 'STUDENT'",
        "          AND cm.member_status IN ('DROPPED', 'TRANSFERRED', 'COMPLETED')",
        "      )",
        "    )",
        "  )",
        "  OR (",

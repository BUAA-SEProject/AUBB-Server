...
import com.aubb.server.application.iam.GovernanceAuthorizationService;
import com.aubb.server.application.iam.IdentityAssignmentCommand;
import com.aubb.server.application.iam.ScopeIdentityService;
...
import com.aubb.server.domain.iam.PasswordPolicy;
import com.aubb.server.domain.iam.PasswordValidationResult;
import com.aubb.server.infrastructure.user.UserEntity;
import com.aubb.server.infrastructure.user.UserMapper;
...
public class UserAdministrationApplicationService {
    ...
    private final com.aubb.server.application.organization.OrganizationApplicationService

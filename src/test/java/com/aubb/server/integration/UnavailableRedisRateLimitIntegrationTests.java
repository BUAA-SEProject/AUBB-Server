...
class UnavailableRedisRateLimitIntegrationTests extends AbstractIntegrationTest {
    ...
    static void rateLimitProperties(DynamicPropertyRegistry registry) {
        ...
        registry.add("aubb.redis.host", () -> "127.0.0.1");
        registry.add("aubb.redis.port", () -> "6390");
        registry.add("aubb.redis.password", () -> "");
        registry.add("aubb.redis.command-timeout", () -> "PT0.2S");
        registry.add("aubb.redis.connect-timeout", () -> "PT0.2S");
    ...
    @Test
    void loginEndpointFallsBackToLocalRateLimitWhenRedisUnavailable() throws Exception {

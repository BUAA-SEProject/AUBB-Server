...
final class AuthzOpenApiAccessRegistry {
    ...
    private static final List<Rule> RULES = List.of(
            ...
            rule("PUT", "^/api/v1/teacher/announcements/\\{[^/]+}$", "announcement.publish"),
            rule("DELETE", "^/api/v1/teacher/announcements/\\{[^/]+}$", "announcement.publish"),
            ...
            rule("PUT", "^/api/v1/teacher/course-resources/\\{[^/]+}$", "resource.manage"),
            rule("DELETE", "^/api/v1/teacher/course-resources/\\{[^/]+}$", "resource.manage"),

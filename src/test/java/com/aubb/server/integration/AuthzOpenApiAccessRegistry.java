...
final class AuthzOpenApiAccessRegistry {
    ...
    private static final List<Rule> RULES = List.of(
            ...
            rule("GET", "^/api/v1/me/course-classes/\\{[^/]+}/announcements$", "RULE.ANNOUNCEMENT_VIEW"),
            rule("GET", "^/api/v1/me/announcements/\\{[^/]+}$", "RULE.ANNOUNCEMENT_VIEW"),
            rule("GET", "^/api/v1/me/course-classes/\\{[^/]+}/resources$", "RULE.RESOURCE_VIEW"),
            rule("GET", "^/api/v1/me/course-resources/\\{[^/]+}/download$", "RULE.RESOURCE_VIEW"),
            rule("POST", "^/api/v1/me/course-classes/\\{[^/]+}/discussions$", "RULE.DISCUSSION_PARTICIPATE"),
            rule("GET", "^/api/v1/me/course-classes/\\{[^/]+}/discussions$", "RULE.DISCUSSION_PARTICIPATE"),
            rule("GET", "^/api/v1/me/discussions/\\{[^/]+}$", "RULE.DISCUSSION_PARTICIPATE"),
            rule("POST", "^/api/v1/me/discussions/\\{[^/]+}/replies$", "RULE.DISCUSSION_PARTICIPATE"),
            ...
            rule("POST", "^/api/v1/teacher/course-offerings/\\{[^/]+}/announcements$", "RULE.ANNOUNCEMENT_MANAGE"),
            rule("GET", "^/api/v1/teacher/course-offerings/\\{[^/]+}/announcements$", "RULE.ANNOUNCEMENT_MANAGE"),
            rule("POST", "^/api/v1/teacher/course-offerings/\\{[^/]+}/resources$", "RULE.RESOURCE_MANAGE"),
            rule("GET", "^/api/v1/teacher/course-offerings/\\{[^/]+}/resources$", "RULE.RESOURCE_MANAGE"),
            rule("GET", "^/api/v1/teacher/course-resources/\\{[^/]+}/download$", "RULE.RESOURCE_MANAGE"),
            rule("POST", "^/api/v1/teacher/course-offerings/\\{[^/]+}/discussions$", "RULE.DISCUSSION_MANAGE"),
            rule("GET", "^/api/v1/teacher/course-offerings/\\{[^/]+}/discussions$", "RULE.DISCUSSION_MANAGE"),
            rule("GET", "^/api/v1/teacher/discussions/\\{[^/]+}$", "RULE.DISCUSSION_MANAGE"),
            rule("POST", "^/api/v1/teacher/discussions/\\{[^/]+}/replies$", "RULE.DISCUSSION_MANAGE"),
            rule("PUT", "^/api/v1/teacher/discussions/\\{[^/]+}/lock-state$", "RULE.DISCUSSION_MANAGE"),
            ...
            rule("POST", "^/api/v1/teacher/course-offerings/\\{[^/]+}/question-bank/questions$", "question.manage"),
            ...
            rule("PUT", "^/api/v1/teacher/question-bank/questions/\\{[^/]+}$", "question.manage"),
            rule("POST", "^/api/v1/teacher/question-bank/questions/\\{[^/]+}/archive$", "question.manage"),
            rule(
                    "GET",

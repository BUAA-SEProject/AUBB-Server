...
仓库当前已经从平台治理推进到课程、assignment 与 submission 的首个真实教学切片，当前已收敛为：
...
- 正式提交受理、学生自查提交、教师按作业查看提交与附件下载
- 评测作业自动入队、学生/教师按提交查看评测作业、教师手动重排队
...
- assignment 当前提供作业主数据与可见性能力；submission 当前提供正式提交受理和附件上传/下载能力；judge 当前提供评测作业入队和查询骨架；真实评测执行与成绩仍留待后续模块。

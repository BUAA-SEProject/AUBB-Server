...
这里只保留能够反映当前代码库真实状态的文档，不保留描述不了现状的占位内容。当前仓库已经覆盖平台治理、课程、assignment、submission、grading、judge 以及 MinIO / go-judge 基础设施的当前切片；继续开发时，先看 README 和仓库结构说明，再进入产品规格与当前执行计划。
